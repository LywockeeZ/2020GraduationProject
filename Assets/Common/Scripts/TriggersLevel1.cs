...
public class TriggersLevel1 : MonoBehaviour
{
    ...
    public void Trigger3()
    {
        ...
        TeachStageHandler stageHandler = Game.Instance.GetCurrentStage() as TeachStageHandler;
        stageHandler.GetBaseUnit(3, 1).SetState(new Fire(stageHandler.GetBaseUnit(3, 1)));
        stageHandler.GetBaseUnit(3, 3).SetState(new Fire(stageHandler.GetBaseUnit(3, 3)));
